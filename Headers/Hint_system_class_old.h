	...
	private:
		...
		*/
		struct Pose_estimation_results
		{
			...
			double accuracy;
			View_graph graph;
			bool invalid_viewpoint_position;
			bool invalid_pose_position;
			bool invalid_z_axis;
			
			Pose_estimation_results () 
		    {
		    	invalid_viewpoint_position = false;
		    	invalid_pose_position = false;
		    	invalid_z_axis = false;
		    }
		};
		...
		*/
		bool
		z_axis_misalignment (Pose_estimation_results per);
		...
		*/
		void
		disable_neighboring_nodes (Pose_estimation_results &per);
		...
		*/
		...
		sort_valid_pose_results (std::vector<Pose_estimation_results> &valid_pose_results);
